...
class Root(Tk):
    def __init__(self):
        ...
        self.options = ['Mongolian', 'Sunda', 'Romania']
    ...
    def btn_clicked(self):
        ...
        if self.language == 'Sunda':
            hasil = penerjemah.translate(self.txtSrc.get(), src='id', dest='su') 
            self.result.delete(0, END)
            self.result.insert(0, hasil.text)
        elif self.language == 'Romania':
            hasil = penerjemah.translate(self.txtSrc.get(), src='id', dest='ro') 
            self.result.delete(0, END)
            self.result.insert(0, hasil.text)
        else:
