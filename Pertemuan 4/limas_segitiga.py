...
class LuasVolumeLimasSegitiga:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Luas dan Volume Limas Segitiga').grid(row=0, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':
    root = Tk()
    aplikasi = LuasVolumeLimasSegitiga(root, "Program Luas dan Volume Limas Segitiga")
    root.mainloop()
